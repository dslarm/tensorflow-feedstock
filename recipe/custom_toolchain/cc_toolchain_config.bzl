...
def _impl(ctx):
    ...
    if "TARGET_PLATFORM".startswith("osx"):
        ...
        if (len("${CUDA_HOME}")):
            ...
            cxx_builtin_include_directories.append("${CUDA_HOME}/targets/${NVARCH}-linux/include/")
            cxx_builtin_include_directories.append("${PREFIX}/targets/${NVARCH}-linux/include")
